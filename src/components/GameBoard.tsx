...
export const GameBoard = () => {
  ...
  // Pre-compute cell ownership map: cellId -> Player (O(P * props) computation on state change, O(1) lookup per cell)
  ...
  // Pre-compute player locations map: cellId -> Player[] (O(P) computation on state change, O(1) lookup per cell)
  ...
  // Pre-compute net worth standings using O(1) fast-path cell property lookups
