...
export const GameBoard = () => {
  ...
  // Precompute player positions map to convert O(C * P) filtering into O(1) lookups during board render
  ...
  // Precompute sorted net worth standings using O(1) fast-path cell lookups
