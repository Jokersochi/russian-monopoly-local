...
export const GameBoard = () => {
  ...
  // $O(1)$ lookup for cell ownership across all players
  const ownerByCellId = useMemo(() => {
    const map: Record<number, typeof players[0]> = {};
  ...
  // $O(1)$ lookup for players present on each cell
  ...
  // Memoized standings calculation to avoid $O(P \times C)$ array filtering on every render
