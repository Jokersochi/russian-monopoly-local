...
export const GameBoard = () => {
  ...
  // Precompute Map lookups and standings in O(P * K) instead of O(C * P) per render frame
    ...
    const standings = players
      .map((p, i) => {
        ...
        for (const propId of p.properties) {
          ...
          if (cell) {
            if (cell.price) propVal += cell.price;
            const hc = houses[propId] || 0;
            if (hc && cell.houseCost) houseVal += hc * cell.houseCost;
          }
        }
