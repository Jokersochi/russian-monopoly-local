...
export const GameBoard = () => {
  ...
  // Fast cell lookup map by cell id
  ...
  // Pre-calculate property owners for O(1) cell lookup
  ...
  // Pre-calculate players per cell for O(1) cell lookup
  ...
  // Pre-calculate sorted net worth standings for O(1) render
      ...
      .map((p, i) => {
        ...
        for (const propId of p.properties) {
          ...
          if (cell) {
            ...
            const hc = houses[cell.id] || 0;
            houseVal += hc * (cell.houseCost || 0);
          }
        }
