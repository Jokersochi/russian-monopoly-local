...
export const GameLog = () => {
  ...
  // Compute reversed log entries, filtered list, and counts by type in a single O(N) pass memoized on gameLog and filter
  const { filtered, counts } = useMemo(() => {
    ...
    // Traverse backward to get reversed order without intermediate array copies
