...
export const GameLog = () => {
  ...
  // Single-pass memoized processing for game log entries.
  // Replaces array cloning/reversal, multiple filter calls, and 8+ countByType O(N) traversals per render
  // with a single backward loop (O(N) time, zero redundant array allocations).
