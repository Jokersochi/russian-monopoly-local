...
export const GameLog = () => {
  ...
  // Single-pass O(N) backward loop within useMemo to simultaneously filter entries,
  // count occurrences by type, and reverse array order without redundant allocations or traversals.
  const { filtered, counts, totalCount } = useMemo(() => {
    ...
    // Traverse backwards so newest entries come first without extra array cloning/reversing
