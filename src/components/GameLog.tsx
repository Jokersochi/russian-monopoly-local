...
export const GameLog = () => {
  ...
  // Performance optimization: Single-pass backward loop inside useMemo.
  // Replaces 11 redundant O(N) array traversals (slice, reverse, filter, and multiple countByType filters)
  // with a single O(N) pass that simultaneously computes entry counts by type and collects reverse-ordered filtered entries.
