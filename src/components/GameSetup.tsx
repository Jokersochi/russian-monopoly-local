    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md shadow-strong backdrop-blur-sm bg-card/95 border-2 border-russia-gold/20 relative z-10">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <label id="language-select-label" className="text-sm font-semibold flex items-center gap-2">
              <span className="text-russia-gold">🌍</span>
              {t('game.language')}
            </label>
            <div className="grid grid-cols-4 gap-2" role="group" aria-labelledby="language-select-label">
              {[
