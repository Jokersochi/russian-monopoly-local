        ...
        {gameState.players.map((player, idx) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="w-full text-left p-3 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold rounded-lg transition-shadow"
              ...
              {isExpanded && (
                <div
                  id={`player-panel-content-${player.id}`}
