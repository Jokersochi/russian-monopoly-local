          ...
          return (
            ...
            >
              <button
                ...
                className="w-full text-left p-3 select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:ring-offset-1 rounded-t-lg"
              ...
              {isExpanded && (
                <div id={`player-details-${idx}`} className="border-t border-border/30 px-3 pb-3 pt-2 space-y-1">
