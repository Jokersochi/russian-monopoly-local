        ...
        {gameState.players.map((player, idx) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="w-full text-left p-3 select-none rounded-lg focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:outline-none transition-colors"
