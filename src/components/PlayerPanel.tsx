          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-3 text-left cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:ring-offset-1 rounded-lg"
