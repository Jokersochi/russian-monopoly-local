          ...
          return (
            ...
            >
              <button
                ...
                aria-controls={"player-panel-content-" + player.id}
                className="p-3 cursor-pointer select-none w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:ring-offset-1"
              ...
              {isExpanded && (
                <div id={"player-panel-content-" + player.id} className="border-t border-border/30 px-3 pb-3 pt-2 space-y-1">
