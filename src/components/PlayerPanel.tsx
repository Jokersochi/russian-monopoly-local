          ...
          return (
            ...
            >
              <button
                ...
                aria-controls={`player-details-${idx}`}
                className="w-full text-left p-3 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background rounded-t-lg"
              ...
              {isExpanded && (
                <div
                  id={`player-details-${idx}`}
                  className="border-t border-border/30 px-3 pb-3 pt-2 space-y-1"
                >
