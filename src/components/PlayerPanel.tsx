        ...
        {gameState.players.map((player, idx) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="w-full text-left p-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:ring-offset-1 rounded-lg select-none"
