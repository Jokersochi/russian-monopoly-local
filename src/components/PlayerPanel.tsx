        ...
        {gameState.players.map((player, idx) => {
          ...
          return (
            ...
            >
              <button
                type="button"
                className="w-full text-left p-3 select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold rounded-lg"
              ...
              {isExpanded && (
                <div
                  ...
                  role="region"
                  aria-labelledby={`player-header-${player.id}`}
