          ...
          return (
            ...
            >
              <div
                ...
                aria-controls={`player-panel-${idx}`}
                className="p-3 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:bg-russia-gold/5 transition-colors"
              ...
              {isExpanded && (
                <div id={`player-panel-${idx}`} className="border-t border-border/30 px-3 pb-3 pt-2 space-y-1">
