          ...
          return (
            ...
            >
              <button
                ...
                aria-controls={`player-panel-content-${idx}`}
                className="w-full text-left p-3 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-russia-gold focus-visible:ring-offset-1 rounded-lg"
              ...
              {isExpanded && (
                <div id={`player-panel-content-${idx}`} className="border-t border-border/30 px-3 pb-3 pt-2 space-y-1">
