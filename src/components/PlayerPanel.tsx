    ...
    <Card className="shadow-board backdrop-blur-sm bg-card/95 border-2 border-russia-gold/20">
      ...
      <div className="p-3 space-y-2">
        {gameState.players.map((player, idx) => {
          ...
          // Optimization: player.properties already contains the IDs of owned cells.
          // Using .length is O(1), whereas cells.filter was O(Cells).
